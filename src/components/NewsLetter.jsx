        ...
        <div className='mx-auto grid lg:grid-cols-3'>
            ...
            <div className='my-4'>
                <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                    ...
                    <input placeholder='email' type="email" className='p-3 flex w-full rounded-md text-black'/>
                    <button className='bg-[#00df9a] text-white rounded-md font-medium w-[200p] ml-4 my-6 px-6 border-none'>Notify Me</button>
                </div>
                <p>We are concerned about the security of your date,Read("")</p>
                <span className='text-[#00df9a]'>Pricacy Policy</span>
            </div>
