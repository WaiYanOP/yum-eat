...
const TopNav = () => {
    ...
    console.log(sideNav)
  return (
    <div className='max-w-[11520] mx-auto flex justify-between items-center p-4'>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:[500px]'>
            ...
            <input type='text' className='bg-transparent p-2 w-full focus:outline-none placeholder:seat' placeholder='search meals'/>
        </div>
